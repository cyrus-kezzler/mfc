...
export const MASTER_INGREDIENTS: Ingredient[] = [
  ...
  { name: 'Carpano Antica Formula Vermouth', type: 'bottle', bottleSize: 1000 },
  { name: 'Aperol', type: 'bottle', bottleSize: 700 },
  { name: 'Belle de Brillet', type: 'bottle', bottleSize: 700 },
  { name: 'Scratch White Rum', type: 'jerry-can' }, // arrives as 125L duty-paid bulk from Canebrake (20 Jul 2026)
  ...
  { name: 'Conotto', type: 'bottle', bottleSize: 500 },
  { name: 'Cranberry', type: 'bottle', bottleSize: 1000 },
  { name: 'Curacao', type: 'bottle', bottleSize: 500 },
  { name: 'Cynar', type: 'bottle', bottleSize: 700 },
  { name: 'Dry Vermouth', type: 'bottle', bottleSize: 750 },
  { name: 'English Whisky', type: 'jerry-can' }, // Cotswold: arrives in 25L jerry cans, priced per litre (Cyrus, 20 Jul 2026)
  ...
  { name: 'Maraschino', type: 'bottle', bottleSize: 700 },
  ...
  { name: 'Pisco', type: 'bottle', bottleSize: 500 },
  ...
  { name: 'Tequila Reposado', type: 'bottle', bottleSize: 700 },
  { name: 'Vodka (Bimber stock)', type: 'bottle', bottleSize: 1000 },
