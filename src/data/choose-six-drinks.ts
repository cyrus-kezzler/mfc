...
export const CHOOSE_SIX_DRINKS: ChooseSixDrink[] = [
  ...
  },
  {
    ...
    name: 'Desert Negroni',
    tagline: 'Blanco tequila in place of gin, sweet vermouth, Campari.',
  ...
  },
  {
    handle: 'manhattan',
    name: 'Manhattan',
    tagline: 'Rye whiskey, two vermouths, bitters. Aged six to eight weeks.',
  ...
  },
  {
    ...
    tagline: 'Aged Cuban rum, two vermouths, grapefruit bitters.',
  ...
  },
  {
    handle: 'red-hook',
    name: 'Red Hook',
    tagline: 'A Manhattan and Brooklyn hybrid: rye, Punt e Mes, maraschino.',
  ...
  },
  {
    ...
    name: 'Gibson Martini',
    tagline: 'Gin, vermouth, onion soaked in and filtered out. A savoury Martini.',
  ...
  },
  {
    handle: 'piscomartini',
    name: 'Pisco Martini',
    tagline: 'Ivy Mix’s fruity Martini: gin, pisco and two vermouths.',
  ...
  },
  {
    handle: 'tuxedo',
    name: 'Tuxedo',
    tagline: 'Old Tom gin, dry vermouth, fino sherry. The 1890s Tuxedo Club classic.',
  ...
  },
  {
    ...
    tagline: 'Gin, Lillet, blue curacao, absinthe in the bottle. Bright and blue on purpose.',
  ...
  },
  {
    handle: 'dempsey',
    name: 'Dempsey',
    tagline: 'Gin, Calvados, absinthe, grenadine. Aged, and the Calvados does the changing.',
  ...
  },
  {
    handle: 'naked-famous',
    name: 'Naked & Famous',
    tagline: 'Mezcal, Chartreuse, Aperol, Myatt’s Sours. Smoky and sharp.',
  ...
  },
  {
    ...
    tagline: 'Bajan rum, demerara, vanilla bitters. Cardamom from the bitters.',
